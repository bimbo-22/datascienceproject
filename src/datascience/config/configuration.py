from src.datascience.constants import * #* --PATH TO CONSTANTS FILE-- 
...
class ConfigurationManager:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        ...
        schema = self.schema # from schema.yaml
        create_directories([config.root_dir])
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        config = self.config.data_transformation # from config.yaml
        create_directories([config.root_dir])
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:   
        ...
        params = self.params.ElasticNet # from params.yaml
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            mlflow_uri="https://dagshub.com/bimbo-22/datascienceproject.mlflow"
        )
